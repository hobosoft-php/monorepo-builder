...
final class ComposerJsonSymlinkerTest extends AbstractKernelTestCase
{
    ...
    {
        yield [
            __DIR__ . '/package-one/composer.json',
            'example/package-two',
            false,
        ...
        yield [
            __DIR__ . '/package-two/composer.json',
            'example/package-one',
            false,
        ...
        yield [
            __DIR__ . '/package-three/composer.json',
            'example/package-one',
            false,
        ...
        yield [
            __DIR__ . '/with-more-depth/package-four/composer.json',
            'example/package-two',
            false,
